...
const Cart = () => {
  ...
  const handlePrice = () => {
    cartProducts?.map((el) => {
      return (total += el.productID.discounted_price * el.qty);
    });
    setTotalPrice(total);
  };
                    ...
                    return (
                      <Tr key={el._id}>
                        ...
                        <Td color={"gray.700"} fontWeight="semibold">
                          <Stack direction={"column"}>
                            <Text color={"red.400"} as="s">
                              RS {el.productID.strike_price}/-
                            </Text>
                            <Text color="blue.500">
                              RS {el.productID.discounted_price}/-
                            </Text>
                          </Stack>
                        </Td>
                        <Td color={"gray.700"} fontWeight="semibold">
                          <Stack direction={{ base: "column", md: "row" }}>
                            <Box
                              onClick={() =>
                                handleUpdateCart(el.qty - 1, el._id)
                              }
                            >
                        ...
                        <Td color="blue.500" fontWeight="semibold">
                          {el.productID.discounted_price * el.qty}/-
                        </Td>
                        <Td color={"gray.700"} fontWeight="semibold">
