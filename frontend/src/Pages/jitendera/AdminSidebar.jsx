...
export const Sidebar = () => {
  ...
  return (
    <Box  bg='white'  position={'sticky'} display={'grid'} mt='20px' gap={'2'}>
      <Link to='/dasboard'><Button  bg={'white'} _focus={{bg:'blue',color:'white'}} _hover={{bg:'blue.200',color:'white'}} p={'30px 0'} w='220px' fontSize={'17px'} fontWeight={'bold'}  ><AiOutlineHome  /> __ DASHBOARD</Button></Link>
